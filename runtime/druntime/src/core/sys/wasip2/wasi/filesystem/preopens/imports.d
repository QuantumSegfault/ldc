...
+/
module core.sys.wasip2.wasi.filesystem.preopens.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.filesystem.preopens.common;

static import core.sys.wasip2.wasi.filesystem.types.imports;
...
+/
alias Descriptor = core.sys.wasip2.wasi.filesystem.types.imports.Descriptor;
...
WitList!(Tuple!(Descriptor, WitString)) getDirectories() @nogc nothrow {
  ...
  auto _list3 = core.sys.wasip2.common.mallocSlice!(Tuple!(Descriptor, WitString))(_listLen3);
