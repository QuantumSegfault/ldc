...
+/
module core.sys.wasip2.wasi.filesystem.types.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.filesystem.types.common;

static import core.sys.wasip2.wasi.io.streams.imports;
static import core.sys.wasip2.wasi.clocks.wall_clock.imports;
...
+/
alias Error_ = core.sys.wasip2.wasi.io.streams.imports.Error_;
  ...
  struct Borrow {
    ...
    Result!(DescriptorStat, ErrorCode) stat() @nogc nothrow {
      ...
      if (_isErr15) {
        ...
        if (_isSome4) {
          core.sys.wasip2.wasi.clocks.wall_clock.imports.Datetime _record3 = {
        ...
        if (_isSome8) {
          core.sys.wasip2.wasi.clocks.wall_clock.imports.Datetime _record7 = {
        ...
        if (_isSome12) {
          core.sys.wasip2.wasi.clocks.wall_clock.imports.Datetime _record11 = {
