...
+/
module core.sys.wasip2.wasi.cli.environment.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.cli.environment.common;
...
WitList!(Tuple!(WitString, WitString)) getEnvironment() @nogc nothrow {
  ...
  auto _list4 = core.sys.wasip2.common.mallocSlice!(Tuple!(WitString, WitString))(_listLen4);
...
WitList!(WitString) getArguments() @nogc nothrow {
  ...
  auto _list2 = core.sys.wasip2.common.mallocSlice!(WitString)(_listLen2);
