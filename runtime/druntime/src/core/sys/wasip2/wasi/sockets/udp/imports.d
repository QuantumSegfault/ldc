...
+/
module core.sys.wasip2.wasi.sockets.udp.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.sockets.udp.common;

static import core.sys.wasip2.wasi.io.poll.imports;
...
+/
alias Pollable = core.sys.wasip2.wasi.io.poll.imports.Pollable;
...
struct UdpSocket {
  ...
  package(core.sys.wasip2) uint __handle = 0;

  package(core.sys.wasip2) this(uint handle) {
    __handle = handle;
  }
  ...
  struct Borrow {
    ...
    Result!(void, ErrorCode) startBind(in Network.Borrow network, in IpSocketAddress localAddress) @nogc nothrow {
      ...
      alias _Tag16 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag;
      final switch (localAddress.tag) {
        case _Tag16.ipv4: {
          const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _payload1 = localAddress.getIpv4();
          _variantPart4 = 0;
        ...
        case _Tag16.ipv6: {
          const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _payload3 = localAddress.getIpv6();
          _variantPart4 = 1;
      ...
      if (_isErr19) {
        ...
        _result19 = Result!(void, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 1)))));
      } else {
    ...
    Result!(void, ErrorCode) finishBind() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(void, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 1)))));
      } else {
    ...
    Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode) stream(in Option!(IpSocketAddress) remoteAddress) @nogc nothrow {
      ...
      if (remoteAddress.isSome) {
        ...
        alias _Tag20 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag;
        final switch (_payload3.tag) {
          case _Tag20.ipv4: {
            const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _payload5 = _payload3.getIpv4();
            _variantPart8 = 0;
          ...
          case _Tag20.ipv6: {
            const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _payload7 = _payload3.getIpv6();
            _variantPart8 = 1;
      ...
      if (_isErr37) {
        ...
        _result37 = Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
    ...
    Result!(IpSocketAddress, ErrorCode) localAddress() @nogc nothrow {
      ...
      if (_isErr11) {
        ...
        _result11 = Result!(IpSocketAddress, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
        core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress _variant7 = void;
        auto _tag7 = cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)));
        alias _Tag7 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag;
        final switch (cast(core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag)_tag7) {
          case _Tag7.ipv4: {
            auto _tuple2 = core.sys.wasip2.wasi.sockets.network.imports.Ipv4Address(
            ...
            core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _record3 = {
              port: cast(ushort)(cast(uint)(*(cast(ushort*)(_retArea.ptr + 8)))),
              address: _tuple2,
            };
            auto _payload8 = _record3;
            _variant7 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.ipv4(_payload8);
            break;
          }
          case _Tag7.ipv6: {
            auto _tuple5 = core.sys.wasip2.wasi.sockets.network.imports.Ipv6Address(
            ...
            core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _record6 = {
              port: cast(ushort)(cast(uint)(*(cast(ushort*)(_retArea.ptr + 8)))),
            ...
            _variant7 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.ipv6(_payload9);
            break;
          }
        }
    ...
    IpAddressFamily addressFamily() @nogc nothrow {
      ...
      return cast(core.sys.wasip2.wasi.sockets.network.imports.IpAddressFamily)(_ret);
    }
    /// ditto
    ...
    Result!(ubyte, ErrorCode) unicastHopLimit() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(ubyte, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 1)))));
      } else {
    ...
    Result!(ulong, ErrorCode) receiveBufferSize() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(ulong, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 8)))));
      } else {
  ...
  struct Borrow {
    ...
    Result!(WitList!(IncomingDatagram), ErrorCode) receive(ulong maxResults) @nogc nothrow {
      ...
      if (_isErr15) {
        ...
        _result15 = Result!(WitList!(IncomingDatagram), ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + size_t.sizeof)))));
      } else {
        auto _listSrcPtr13 = *(cast(void**)(_retArea.ptr + size_t.sizeof));
        auto _listLen13 = *(cast(size_t*)(_retArea.ptr + (2*size_t.sizeof)));
        auto _list13 = core.sys.wasip2.common.mallocSlice!(IncomingDatagram)(_listLen13);
        foreach (_elem1_idx, ref _elem1; _list13) {
          ...
          core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress _variant9 = void;
          auto _tag9 = cast(uint)(*(cast(ubyte*)(_base1 + (2*size_t.sizeof))));
          alias _Tag9 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag;
          final switch (cast(core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.Tag)_tag9) {
            case _Tag9.ipv4: {
              auto _tuple4 = core.sys.wasip2.wasi.sockets.network.imports.Ipv4Address(
              ...
              core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _record5 = {
                port: cast(ushort)(cast(uint)(*(cast(ushort*)(_base1 + (4+2*size_t.sizeof))))),
                address: _tuple4,
              };
              auto _payload10 = _record5;
              _variant9 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.ipv4(_payload10);
              break;
            }
            case _Tag9.ipv6: {
              auto _tuple7 = core.sys.wasip2.wasi.sockets.network.imports.Ipv6Address(
              ...
              core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _record8 = {
                port: cast(ushort)(cast(uint)(*(cast(ushort*)(_base1 + (4+2*size_t.sizeof))))),
              ...
              _variant9 = core.sys.wasip2.wasi.sockets.network.imports.IpSocketAddress.ipv6(_payload11);
              break;
            }
          }
...
struct OutgoingDatagramStream {
  ...
  struct Borrow {
    ...
    Result!(ulong, ErrorCode) send(in WitList!(OutgoingDatagram) datagrams) @nogc nothrow {
      ...
      auto _list10 = core.sys.wasip2.common.malloc(_listSrc10.length * ((32+3*size_t.sizeof)));
      scope(exit) { core.sys.wasip2.common.free(_list10); }
        ...
        if (_elem0.remoteAddress.isSome) {
          ...
          *cast(ubyte*)(_base0 + (2*size_t.sizeof)) = cast(ubyte)(1);
          ...
          final switch (_payload4.tag) {
            case _Tag9.ipv4: {
              const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _payload6 = _payload4.getIpv4();
            ...
            case _Tag9.ipv6: {
              const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _payload8 = _payload4.getIpv6();
      ...
      if (_isErr13) {
        ...
        _result13 = Result!(ulong, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 8)))));
      } else {
