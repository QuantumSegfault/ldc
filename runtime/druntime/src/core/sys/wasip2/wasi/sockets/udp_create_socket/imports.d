...
+/
module core.sys.wasip2.wasi.sockets.udp_create_socket.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.sockets.udp_create_socket.common;

static import core.sys.wasip2.wasi.sockets.network.imports;
static import core.sys.wasip2.wasi.sockets.udp.imports;
...
+/
alias UdpSocket = core.sys.wasip2.wasi.sockets.udp.imports.UdpSocket;
...
Result!(UdpSocket, ErrorCode) createUdpSocket(in IpAddressFamily addressFamily) @nogc nothrow {
  ...
  if (_isErr2) {
    ...
    _result2 = Result!(UdpSocket, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
  } else {
