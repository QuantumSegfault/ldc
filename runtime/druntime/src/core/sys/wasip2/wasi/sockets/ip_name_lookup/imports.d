...
+/
module core.sys.wasip2.wasi.sockets.ip_name_lookup.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.sockets.ip_name_lookup.common;
  ...
  struct Borrow {
    ...
    Result!(Option!(IpAddress), ErrorCode) resolveNextAddress() @nogc nothrow {
      ...
      if (_isErr12) {
        ...
        _result12 = Result!(Option!(IpAddress), ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 2)))));
      } else {
        Option!(IpAddress) _option10 = void;
        bool _isSome10 = (cast(uint)(*(cast(ubyte*)(_retArea.ptr + 2)))) != 0;
        if (_isSome10) {
          core.sys.wasip2.wasi.sockets.network.imports.IpAddress _variant7 = void;
          auto _tag7 = cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)));
          alias _Tag7 = core.sys.wasip2.wasi.sockets.network.imports.IpAddress.Tag;
          final switch (cast(core.sys.wasip2.wasi.sockets.network.imports.IpAddress.Tag)_tag7) {
            case _Tag7.ipv4: {
              ...
              _variant7 = core.sys.wasip2.wasi.sockets.network.imports.IpAddress.ipv4(_payload8);
              break;
            }
            case _Tag7.ipv6: {
              auto _tuple6 = core.sys.wasip2.wasi.sockets.network.imports.Ipv6Address(
              ...
              _variant7 = core.sys.wasip2.wasi.sockets.network.imports.IpAddress.ipv6(_payload9);
              break;
            }
          }
...
Result!(ResolveAddressStream, ErrorCode) resolveAddresses(in Network.Borrow network, in WitString name) @nogc nothrow {
  ...
  if (_isErr2) {
    ...
    _result2 = Result!(ResolveAddressStream, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
  } else {
