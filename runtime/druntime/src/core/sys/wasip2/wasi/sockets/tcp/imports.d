...
+/
module core.sys.wasip2.wasi.sockets.tcp.imports;

import core.sys.wasip2.common;

public import core.sys.wasip2.wasi.sockets.tcp.common;

static import core.sys.wasip2.wasi.io.poll.imports;
static import core.sys.wasip2.wasi.io.streams.imports;
static import core.sys.wasip2.wasi.clocks.monotonic_clock.imports;
  ...
  struct Borrow {
    ...
    Result!(void, ErrorCode) startConnect(in Network.Borrow network, in IpSocketAddress remoteAddress) @nogc nothrow {
      ...
      final switch (remoteAddress.tag) {
        case _Tag16.ipv4: {
          const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv4SocketAddress _payload1 = remoteAddress.getIpv4();
          _variantPart4 = 0;
          _variantPart5 = cast(uint)(_payload1.port);
          _variantPart6 = cast(uint)(_payload1.address[0]);
          _variantPart7 = cast(uint)(_payload1.address[1]);
        ...
        case _Tag16.ipv6: {
          const ref core.sys.wasip2.wasi.sockets.network.imports.Ipv6SocketAddress _payload3 = remoteAddress.getIpv6();
          _variantPart4 = 1;
          _variantPart5 = cast(uint)(_payload3.port);
          _variantPart6 = _payload3.flowInfo;
          _variantPart7 = cast(uint)(_payload3.address[0]);
    ...
    Result!(Tuple!(InputStream, OutputStream), ErrorCode) finishConnect() @nogc nothrow {
      ...
      if (_isErr3) {
        ...
        _result3 = Result!(Tuple!(InputStream, OutputStream), ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
    ...
    Result!(Tuple!(TcpSocket, InputStream, OutputStream), ErrorCode) accept() @nogc nothrow {
      ...
      if (_isErr3) {
        ...
        _result3 = Result!(Tuple!(TcpSocket, InputStream, OutputStream), ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
    ...
    Result!(bool, ErrorCode) keepAliveEnabled() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(bool, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 1)))));
      } else {
    ...
    Result!(Duration, ErrorCode) keepAliveIdleTime() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(Duration, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 8)))));
      } else {
    ...
    Result!(uint, ErrorCode) keepAliveCount() @nogc nothrow {
      ...
      if (_isErr2) {
        ...
        _result2 = Result!(uint, ErrorCode).err(cast(core.sys.wasip2.wasi.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
