...
fail_compilation/reserved_version.d(217): Error: version identifier `CppRuntime_LLVM` is reserved and cannot be set
fail_compilation/reserved_version.d(218): Error: version identifier `CppRuntime_DigitalMars` is reserved and cannot be set
fail_compilation/reserved_version.d(219): Error: version identifier `CppRuntime_GNU` is reserved and cannot be set
fail_compilation/reserved_version.d(220): Error: version identifier `CppRuntime_Microsoft` is reserved and cannot be set
fail_compilation/reserved_version.d(221): Error: version identifier `CppRuntime_Sun` is reserved and cannot be set
fail_compilation/reserved_version.d(222): Error: version identifier `D_PIE` is reserved and cannot be set
fail_compilation/reserved_version.d(223): Error: version identifier `AVR` is reserved and cannot be set
fail_compilation/reserved_version.d(224): Error: version identifier `D_PreConditions` is reserved and cannot be set
fail_compilation/reserved_version.d(225): Error: version identifier `D_PostConditions` is reserved and cannot be set
fail_compilation/reserved_version.d(226): Error: version identifier `D_ProfileGC` is reserved and cannot be set
fail_compilation/reserved_version.d(227): Error: version identifier `D_Invariants` is reserved and cannot be set
fail_compilation/reserved_version.d(228): Error: version identifier `D_Optimized` is reserved and cannot be set
fail_compilation/reserved_version.d(229): Error: version identifier `VisionOS` is reserved and cannot be set
---
*/
